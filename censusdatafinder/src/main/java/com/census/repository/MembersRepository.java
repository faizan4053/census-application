...
//	 
	...
	@Query("select u from Members u where u.firstName = :firstname and u.lastName = :lastname")
	 ...
	 @Query("select u from Members u where u.memberId =:criteria or u.firstName=:criteria "
	 		+ "or u.lastName=:criteria or u.familyCode=:criteria or u.memberDateOfBirth=:criteria")
	 List<Members> searchMembersWithCriteria(@Param("criteria") String criteria);
}
